      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            _buildTextField("Contoh: Google Architect", controller: controller.titleC),
            
            _buildInputLabel("PENYELENGGARA"),
            _buildTextField("Contoh: Coursera", controller: controller.institutionC),
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      _buildTextField("Pilih Tanggal", controller: controller.dateC, icon: Icons.calendar_today),
                    ],
                  ),
                ),
            ...
            Obx(() => ElevatedButton(
              onPressed: controller.isLoading.value ? null : () => controller.saveCertificate(),
              ...
              child: controller.isLoading.value 
                    ...
                    : const Text("Simpan Sertifikat", style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold)),
            )),
          ],
        ),
      ),
