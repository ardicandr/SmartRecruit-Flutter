...
class HomeView extends GetView<HomeController> {
  ...
  Widget _buildMainHome() {
    return SafeArea(
      child: RefreshIndicator(
        // Tambahkan ini agar bisa tarik layar untuk refresh
  ...
  Widget _buildHorizontalList() {
      ...
      return Container(
        ...
        child: Column(
          children: [
            ...
            ElevatedButton(
              onPressed: () =>
                  controller.changeTabIndex(3), // Pergi ke tab Profil
              style: ElevatedButton.styleFrom(
    ...
    if (controller.specialJobs.isEmpty)
                      ...
                      job.companyLogo != null && job.companyLogo!.isNotEmpty
                          ? CircleAvatar(
                              ...
                              backgroundImage: NetworkImage(
                                '${ApiProvider.hostUrl}${job.companyLogo}',
                              ),
                            )
                          : const CircleAvatar(
                              backgroundColor: Colors.white,
  ...
  Widget _buildVerticalList() {
    if (controller.latestJobs.isEmpty)
      return const Center(child: Text("Belum ada lowongan terbaru"));
