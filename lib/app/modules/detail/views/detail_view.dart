...
class DetailView extends GetView<DetailController> {
  ...
  Widget build(BuildContext context) {
    // 1. Menangkap data yang dikirim dari halaman sebelumnya
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              "Kami mencari ${jobData['title']} yang visioner untuk bergabung dengan tim desain kami yang berkembang pesat. Anda akan bertanggung jawab untuk memimpin inisiatif desain end-to-end, mulai dari riset pengguna hingga prototipe fidelitas tinggi.",
            ...
            _buildRequirementList([
              ...
              "Memiliki portofolio yang kuat menunjukkan pemecahan masalah.",
              "Keahlian komunikasi yang baik dan mampu bekerja dalam tim.",
            ...
            Wrap(
              spacing: 8,
              runSpacing: 8,
              children: (jobData['tags'] as List? ?? ["Figma", "UI Design", "UX Research"]).map((tag) => _buildSkillChip(tag.toString())).toList(),
            ),
            const SizedBox(height: 40),
            ...
            Row(
              ...
              children: [
                ...
                Text(
                  "15 Oktober 2024",
                  style: TextStyle(color: Colors.red[600], fontWeight: FontWeight.bold, fontSize: 13),
                ),
              ],
            ),
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                ...
                style: const TextStyle(color: Color(0xFF2170E4), fontWeight: FontWeight.w600, fontSize: 15),
              ),
              const SizedBox(height: 4),
              Row(
                children: [
  ...
  Widget _buildAiMatchCard(Map<String, dynamic> data) {
    // Ambil nilai persen (misal "92%") lalu ubah ke double 0.92
            ...
            children: [
              Row(
                children: [
                  ...
                  Text(
                    "AI Match Score",
                    style: GoogleFonts.plusJakartaSans(fontWeight: FontWeight.w800, color: const Color(0xFF001A42), fontSize: 16),
                  ),
                ],
              ),
              Container(
                padding: const EdgeInsets.symmetric(horizontal: 10, vertical: 4),
                decoration: BoxDecoration(color: const Color(0xFF2170E4), borderRadius: BorderRadius.circular(20)),
                child: Text(matchStr, style: const TextStyle(color: Colors.white, fontSize: 11, fontWeight: FontWeight.bold)),
              ),
            ],
          ),
          const SizedBox(height: 12),
          const Text(
            "Profil Anda sangat cocok dengan kualifikasi pekerjaan ini. Keterampilan keahlian Anda menjadi keunggulan utama.",
            style: TextStyle(color: Color(0xFF0058BE), fontSize: 13, height: 1.5),
          ),
          const SizedBox(height: 20),
          ClipRRect(
            borderRadius: BorderRadius.circular(10),
      ...
      children: items.map((text) => Padding(
        ...
        child: Row(
          ...
          children: [
            ...
            Expanded(child: Text(text, style: TextStyle(color: AppColors.textGray, fontSize: 14, height: 1.4))),
          ],
        ),
      )).toList(),
    );
  ...
  Widget _buildSkillChip(String label) {
    return Container(
      ...
      child: Text(label, style: const TextStyle(fontSize: 13, fontWeight: FontWeight.w500, color: Color(0xFF545F73))),
    );
  }
    ...
    return Container(
      ...
      child: Row(
        children: [
          ...
          const SizedBox(width: 16),
          Text(text, style: const TextStyle(fontSize: 13, fontWeight: FontWeight.w600, color: Color(0xFF424754))),
        ],
      ),
    );
  }
        ...
        children: [
          const Row(
            ...
            children: [
              ...
              SizedBox(width: 6),
              Text("Data Anda akan diproses otomatis oleh AI kami.", style: TextStyle(color: Colors.grey, fontSize: 10)),
            ],
          ),
          const SizedBox(height: 16),
          ElevatedButton(
