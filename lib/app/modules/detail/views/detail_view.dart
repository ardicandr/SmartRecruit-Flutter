        ...
        child: Column(
          ...
          children: [
            ...
            _buildRequirementList(
              (jobData['requirements'] ?? "Belum ada persyaratan detail")
                  .toString()
                  .split(RegExp(r'\n|- '))
            ...
            const SizedBox(height: 16),
            ...(jobData['facilities'] != null &&
                    jobData['facilities'].toString().trim().isNotEmpty
                ? jobData['facilities']
                      .toString()
                      .split(',')
    ...
    return Row(
      children: [
        Container(
          ...
          decoration: BoxDecoration(
            ...
            image:
                data['companyLogo'] != null &&
                    data['companyLogo'].toString().isNotEmpty
                ? DecorationImage(
                    image: NetworkImage(
                      '${ApiProvider.hostUrl}${data['companyLogo']}',
                    ),
                    fit: BoxFit.cover,
                  )
                : null,
          ...
          child:
              (data['companyLogo'] == null ||
                  data['companyLogo'].toString().isEmpty)
              ? const Icon(
        ...
        children: [
          const Row(
            ...
            children: [
              ...
              SizedBox(width: 6),
              Text(
                "Data Anda akan diproses otomatis oleh AI kami.",
